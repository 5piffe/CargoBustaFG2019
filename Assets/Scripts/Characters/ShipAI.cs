...
public class ShipAI : Enemy
{
    ...
    [SerializeField]
    private TargetData tData = null;
    private float flareCooldown = 0;
    [SerializeField]
    private float rotationSpeed = 2000f, speed = 20f;
    ...
    [SerializeField]
    private FlareGun flareGun = null;
    ...
    private void Chase()
    {
        //Debug.Log(missileTrackable.trackedList.Count);
    ...
    private void Run()
    {
        ...
        //missileTrackable.trackedList.RemoveNull();
