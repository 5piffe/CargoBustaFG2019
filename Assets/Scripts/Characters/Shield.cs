...
public class Shield : Character
{
    ...
    protected override void Update()
    {
        ...
        else if (health < currentDamageState * healthStep)
        {
            currentDamageState--;
    ...
    public void Activate()
    {
        //Debug.Log(Health);
        //Debug.Log(hp);
        //Debug.Log(Mathf.RoundToInt((((activationTimer / activationTime) * hp) - ((activationTimer / activationTime) * hp) % healthStep) / healthStep));
        //Debug.Log(healthStep);
        //Debug.Log(activationTime);
